export class JwtHelper {
	...
	public getTokenExpirationDate(token: string | Promise<string>): Date | null | Promise<Date | null> {
		if (token instanceof Promise) {
	...
	public isTokenExpired(token: string | Promise<string>, offsetSeconds?: number): boolean | Promise<boolean> {
		if (token instanceof Promise) {
