...
import { AnnualFacilityUsagesRepository } from './annual-facility-usages.repository';

describe('AnnualFacilityUsagesRepository', () => {
	let service: AnnualFacilityUsagesRepository;
	...
	beforeEach(() => {
		...
		service = TestBed.inject(AnnualFacilityUsagesRepository);
	});
	...
	it('should have the correct api_url', () => {
		expect(service.api_url).toBe('/api/edf/rand/annual-facility-usages');
	});

	it('should have the correct kind', () => {
		expect(service.kind).toBe('annual-facility-usages');
	});
