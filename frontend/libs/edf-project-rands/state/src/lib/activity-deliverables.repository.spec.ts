...
import { ActivityDeliverablesRepository } from './activity-deliverables.repository';

describe('ActivityDeliverablesRepository', () => {
	let service: ActivityDeliverablesRepository;
	...
	beforeEach(() => {
		...
		service = TestBed.inject(ActivityDeliverablesRepository);
	});
	...
	it('should have the correct api_url', () => {
		expect(service.api_url).toBe('/api/edf/rand/activity-deliverables');
	});

	it('should have the correct kind', () => {
		expect(service.kind).toBe('activity-deliverables');
	});
